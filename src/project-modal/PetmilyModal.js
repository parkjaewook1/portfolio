          ...
          <div className="modal-info-tasks">
              ...
              <div className="project-task">
                  ...
                  <p>
                      ...
                      <ul>
                          <li>
                              <h4>투데이(Today) 기능:</h4> 방문자가 다이어리에 접속할 때마다
                              실시간으로 오늘의 방문자 수(Today)와 누적 방문자 수(Total)를
                              집계하여 보여줍니다.
                          </li>
                          <li>
                              <h4>프로필 관리:</h4> 상태 메시지, 자기소개, 프로필 사진을 자유롭게
                              꾸밀 수 있으며, 작성한 일기들의 '기분(Mood)' 데이터를 분석하여 월별
                              감정 통계를 시각적인 도넛 차트로 제공합니다.
                          </li>
                      </ul>
                  </p>
                  <br />
                  ...
                  <p>
                      ...
                      <ul>
                          ...
                          <li>
                              ...
                              접히고, <strong>'더보기/접기'</strong> 버튼이 생성되어 깔끔한
                              댓글창을 유지합니다.
                          </li>
                          <li>
